...
struct DummyData {
    ...
    static let dummyDataStatistic: Statistic = Statistic(title: "Market Cap", value: "$12.58n", percentageChange: 25.34)
    static let dummyDataStatistic2: Statistic = Statistic(title: "Total Volume", value: "$1.23Tr")
    static let dummyDataStatistic3: Statistic = Statistic(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
